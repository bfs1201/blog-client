...
export function updateProfileApi(data) {
    return request({
        url: '/api/protal/user/updateProfile',
        method: 'put',
        data
    })
}
...
export function delMyCommentApi(id) {
    return request({
        url: `/api/protal/user/delMyComment/${id}`,
        method: 'delete'
    })
}
